  ...
  useEffect(() => {
    if (typeof window !== "undefined" && pendingParticipantId) {
      const frame = window.requestAnimationFrame(() => {
        setSalonUrl(
          `${window.location.origin}/uss/salon?session=${EXPO_SESSION_ID}&pid=${pendingParticipantId}`,
        );
      });
          ...
          {displayIsPlaying && currentParticipant ? (
            ...
            <>
              ...
              <div className="expo__introNote">
                <h3 className="expo__introTitle">Cuánto sabes de fauna silvestre</h3>
              </div>
        ...
        {!displayIsPlaying ? (
          <div className="expo__ranking">
            <div className="expo__rankingHeader">
              <p className="expo__participantLabel">Ranking USS</p>
            </div>
            ...
            <div className="expo__rankingViewport">
              ...
              {rankingParticipants.length > 0 ? (
                ...
                <div className="expo__rankingEmpty">
                  Aún no hay participantes en el ranking. Se llenará a medida que
                  respondan el quiz USS.
                </div>
              )}
              </div>
            </div>
