  ...
  return (
    <div style={pageStyle}>
      ...
      <div style={{ padding: "20px 16px 0" }}>
        ...
        {!!species.supportSections?.length && (
          <div style={{ marginBottom: 20 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
              <div style={{ width: 4, height: 20, background: "#0f766e", borderRadius: 2 }} />
              <h2 style={{ fontSize: 14, fontWeight: 800, color: "#0f766e", margin: 0, textTransform: "uppercase", letterSpacing: 0.5 }}>
                Material complementario
              </h2>
            </div>
            <div style={{ display: "grid", gap: 12 }}>
              {species.supportSections.map((section) => (
                <div
                  key={section.title}
                  style={{
                    background: "#f8fafc",
        ...
        {!!species.galleryImages?.length && (
          <div style={{ marginBottom: 24 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
              <div style={{ width: 4, height: 20, background: "#b45309", borderRadius: 2 }} />
              <h2 style={{ fontSize: 14, fontWeight: 800, color: "#b45309", margin: 0, textTransform: "uppercase", letterSpacing: 0.5 }}>
                Láminas de apoyo
              </h2>
            </div>
            <div style={{ display: "grid", gap: 12 }}>
              {species.galleryImages.map((image) => (
                <figure
                  key={image.src}
                  style={{
                    margin: 0,
                ...
                >
                  <img
                    src={image.src}
                    alt={image.alt}
                    style={{ display: "block", width: "100%", height: "auto", background: "#e5e7eb" }}
                  />
                  {image.caption && (
                    <figcaption style={{ padding: "10px 12px", fontSize: 12, color: "#4b5563", lineHeight: 1.5 }}>
                      {image.caption}
                    </figcaption>
                  )}
                </figure>
